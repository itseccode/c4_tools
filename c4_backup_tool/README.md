...
Подача через API Континент 4 команды на создание резервной копии БД конфигурации ЦУС в его репозитории, затем - выгрузка файла резервной копии.
...
3. Выгрузка файла резервной копии из репозитория и сохранение на АРМ пользователя.
...
7. Инструмент готов к использованию.
