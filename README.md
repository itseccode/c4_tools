...
| `aserv_c4_importer`     | Инструмент для переноса (миграции) данных с СД Континент 3 на СД Континент 4                                | Online  | Только совместно с `c4_lib`, Континент 3.9.4 &rarr; Континент 4.1.9 |
