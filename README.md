...
| `convert_cisco_to_c4`   | Инструмент для конвертации конфигурации из `*.txt` (running) Cisco ASA и последующего импорта в Континент 4 | Offline | Cisco ASA 8.4 / 9.1 &rarr; Континент 4.1.7 и выше         |
