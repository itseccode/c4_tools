...
9. При импорте правил из Check Point в К4 тип трансляции переносится согласно следующим правилам:
    - если на стороне Check Point значения **Source (Original)**, **Destination (Original)** и **Service (Original)** соответственно равны значениям **Source (Translated)**, **Destination (Original)**, **Service (Translated)** на стороне К4 для параметра **Трансляция** будет установлено значение **Не транслировать** / **No NAT**;
    - если на стороне Check Point значения **Source (Original)** и **Source  (Translated)** между собой не равны и значения **Destination (Original)** и **Destination  (Translated)** равны на стороне К4 для параметра **Трансляция** будет установлено значение **Отправителя** / **Source**;
    - если на стороне Check Point значения **Destination (Original)** и **Destination (Translated)** не равны и значения **Source (Original)** и **Source  (Translated)** между собой не равны на стороне К4 для параметра **Трансляция** будет установлено значение **Получателя** / **Destination**.
